...
public class StringEquals {
    public static void main(String[] args) {
        ...
        // Ссылочный тип данных. В переменной str1 хранится ссылка на область в памяти ,в которой хранится объект типа String (значение)
        String str1 = "Java";
        String str2 = "Java";
        String str3 = "JAVA";
        ...
        // Мы можем сравнить значения, игнорируя регистр букв
        System.out.println("\"java\".equalsIgnoresCase\"JAVA\": " + str1.equalsIgnoreCase(str3)); // java равно по значению JAVA
